...
def _get_key_and_transform_mapping(cfg: model_lib.ModelConfig):
  ...
  return {
      r"(?:language_model\.)?model\.embed_tokens\.weight": ("embedder.input_embedding", None),
      ...
      r"vision_tower\..*": ("unused.vision_tower", None),
      r"multi_modal_projector\..*": ("unused.mm_projector", None),
  }
